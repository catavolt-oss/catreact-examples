                        ...
                        <div className="panel panel-primary">
                            ...
                            <div className="panel-body row">
                                <CvLauncher actionId={"AAABACfaAAAABpIk"}
                                    ...
                                    return (
                                        <div onClick={callback.fireLaunchAction} className="col-sm-8 launch-div">
                                    ...
                                    <ul className={'list-group'}>
                                        <CvListPane paneRef={0}>
                                            <CvRecordList wrapperElemName={'span'} rowRenderer={(cvContext, record)=>{
                                                ...
                                                return (
                                                    <CvRecord entityRec={record} key={record.objectId}>
 ...
 */
const BuzzMessages = React.createClass<{}, {openNewMessageFormResult}>({
                        ...
                        <CvForm>
                            <CvListPane paneRef={0}>
                                <div className="panel panel-primary">
                                    <div className="panel-heading">
                                        <i id={'loading'}
                                           className="fa fa-spinner fa-pulse fa-2x pull-right show"/>
                                        <h4>Messages</h4>
...
const BuzzPostMessage = React.createClass<{navigationResult}, any>({
    ...
    render: function () {
        return (
                    <CvNavigation navigationResult={this.props.navigationResult}>
                        <CvForm>
                            <CvDetailsPane paneRef={0} detailsRenderer={(cvContext:CvContext,
                             record:EntityRec, detailsCallback:CvDetailsPaneCallback)=>{
                                return (
                                <CvRecord entityRec={record} renderer={(cvContext:CvContext)=>{
                                   ...
                                   const propChange = (fieldName:string, e:any) => {
                                   ...
                                   const onSubmit = (e:any)=>{
                                        e.preventDefault();
                                        $('#loading').addClass('show').removeClass('hidden');
                                        detailsCallback.saveChanges((navEvent:CvEvent<CvNavigationResult>, error:any)=>{
                                            if(error) {
                                                $('#loading').addClass('hidden').removeClass('show');
                                                Log.error(error);
                                            }else {
                                                if(navEvent) Log.info("There was a navigation.")
                                                var m:any = $('#postModal');
                                    ...
                                    <form className="form-horizontal" onSubmit={onSubmit}>
                                        <div className="modal fade" role="dialog" id="postModal" ref={(d:any)=>{
                                                var m:any = $(d);
                                                if(m && m.modal){ m.modal({show:true, keyboard: true} ) }
                                                 $('#loading').addClass('hidden').removeClass('show');
                                          }}>
                                              ...
                                              <div className="modal-body">
                                                    <div className="well">
                                                        ...
                                                        <div className="form-group">
                                                            ...
                                                            <div className="col-sm-9">
                                                                <input id="image1" type="file" className="form-control"
                                                                       onChange={imageChange.bind(undefined, 'P_image')}/>
                                                                 <br/>
