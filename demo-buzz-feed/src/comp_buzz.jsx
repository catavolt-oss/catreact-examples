...
const BuzzLogin = React.createClass({
    mixins: [BuzzBase],
    render: function () {
        return <CvLoginPanel defaultGatewayUrl={'gw.catavolt.net'} defaultTenantId={'catavolt-dev'} defaultUserId={'rob'} defaultPassword={''} showGatewayUrl={false} showClientType={false} loginListeners={[(event) => {
